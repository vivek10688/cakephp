    ...
    public function preset($name){ 
        ...
        if($name == 'basic'){ 
            return array( 
                ...
                'relative_urls' => false,
                'toolbar1' => 'undo, redo, |, fontselect, |, fontsizeselect, |, bold, italic, |, alignleft, aligncenter, alignright, alignjustify, |, bullist, numlist, outdent, indent, |emoticons, |, colorpicker, forecolor, backcolor, |, preview'
