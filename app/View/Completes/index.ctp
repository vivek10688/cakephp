				...
				<div class="panel panel-default">					
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
						  <div class="col-md-12 col-sm-12 col-xs-12 mrg">
						  	<div class="text-center"><?php echo$this->Html->image('logo-website.fw.png',array('alt'=>$siteName,'class'=>'img-responsive.img-center'));?></div>
						  ...
						  <div class="col-md-6 col-sm-6 col-xs-6 mrg">
						     <div class="text-center"> <?php echo$this->Html->link($this->Html->image('admin.png',array('alt'=>'Admin','class'=>'img-responsive.img-center')),'../admin/',array('escape'=>false));?></div>
						      <div class="text-center"><span class="text-muted"><h4><strong><?php echo$this->Html->link(__('Go to Admin Interface'),'../admin/');?></strong></h4></span></div>
						  ...
						  <div class="text-center"> <?php echo$this->Html->link($this->Html->image('graduated.png',array('alt'=>'Admin','class'=>'img-responsive.img-center')),'../',array('escape'=>false));?> </div>
						   <div class="text-center"> <span class="text-muted"><h4><strong><?php echo$this->Html->link(__('Go to Front End/Member Interface'),'../');?></strong></h4></span></div>
						   <div class="text-center"> <span class="text-danger"><strong><?php echo __('User');?> : member@demo.com</strong></span></div>
	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-footer">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 text-center"><?php echo __('Visit our website');?> <?php echo$this->Html->link('http://www.elfemo.com','http://elfemo.com',array('target'=>'_blank'));?> <?php echo __('for documentation and support');?></div>
				</div>
			</div>
		</div>
	</div>
