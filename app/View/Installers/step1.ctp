		...
		<div class="row">	
			<div  class="col-md-12 mrg">
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo$this->Html->image('logo-website.fw.png',array('alt'=>'Elfemo Leadbook','class'=>'img-responsive'));?></div>
...
<p>
Standard Licence holders must display the www.elfemo.com back link in an un-alerted state. Sites with modified or removed back links will not be supported
<br></p>
...
<p>Please contact us if you have any requirements that are not covered by these terms.
						...
						<div style="margin-left: 20px;"><?php echo$this->Form->input('accept',array('type'=>'checkbox','id'=>'checkme','label'=>__('I Accept to Proceed'),'hiddenField'=>false));?></div>
	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-footer">
				<div class="row">					
					<div class="col-md-12 text-center"><?php echo __('Visit our website');?> <?php echo$this->Html->link('http://www.elfemo.com','http://www.elfemo.com',array('target'=>'_blank'));?> <?php echo __('for documentation and support');?></div>
				</div>
			</div>
		</div>
	</div>
