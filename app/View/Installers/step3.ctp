					...
					<?php echo $this->Form->create('Installer',array('controller' => 'Installer','action'=>'step3','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
					  ...
					  <p class="btn btn-primary"><?php echo __('Step 4 of 4');?></p>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<?php echo$this->Form->hidden('step3',array('value'=>1));?>
								</div>
							</div>
							<div class="form-group">
	...
	<div class="container">
		<div class="panel panel-success">
			<div class="panel-footer">
				<div class="row">					
					<div class="col-md-12 text-center">Visit our website <?php echo$this->Html->link('http://www.elfemo.com','http://www.elfemo.com',array('target'=>'_blank'));?> for documentation and support</div>
			</div>
		</div>
	</div>
  </body>
