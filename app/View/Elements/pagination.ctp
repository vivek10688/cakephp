...
<?php }?>
        ...
        <div class="col-md-5">
            <ul class="pagination pagination-sm">
                <?php echo $this->Paginator->prev('&larr; Prev',array('tag'=>'li','escape'=>false),'<a>&larr;'.__('Prev').'</a>',array('class'=>'disabled','tag'=>'li','escape'=>false));
                ...
                echo $this->Paginator->next('Next &rarr;',array('tag'=>'li','escape'=>false),'<a>&rarr; '.__('Next').'</a>',array('class'=>'disabled','tag'=>'li','escape'=>false));?>
            </ul>
        </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <?php echo $this->Form->input('keyword', array('required'=>true,'div' => false,'label'=>false,'class'=>'form-control','placeholder'=>__('Search'),'empty' => true));?>
