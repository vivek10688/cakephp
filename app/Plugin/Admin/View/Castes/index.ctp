...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Castes');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Castes')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Caste'),array('controller'=>'Castes','action'=>'add'),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Form->create(array('name'=>'deleteallfrm','action' => 'deleteall'));?>    
	...
	<div class="table-responsive">
		...
		<tr>
		    ...
		    <th><?php echo $this->Paginator->sort('name',__('Caste Name'), array('direction' => 'asc'));?></th>
		    <th><?php echo __('Action');?></th>
		</tr>
		<?php foreach ($Caste as $post):
		$id=$post['Caste']['id'];?>
		<tr>
		    <td><?php echo $this->Form->checkbox(false,array('value' => $post['Caste']['id'],'name'=>'data[Caste][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
		    <td><?php echo $serialNo++; ?></td>
		    <td><?php echo h($post['Religion']['name']); ?></td>
		    <td><?php echo h($post['Caste']['name']); ?></td>
