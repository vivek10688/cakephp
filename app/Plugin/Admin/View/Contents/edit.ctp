						...
						<div class="panel panel-default">
							...
							<div class="panel-body"><?php echo $this->Session->flash();?>
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_title",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Title','div'=>false));?>
								    </div>
								    <label for="group_name" class="col-sm-2 control-label"><small>Meta Keyword</small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_keyword",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Keyword','div'=>false));?>
								    </div>
								</div>
								 <div class="form-group">
								    <label for="group_name" class="col-sm-2 control-label"><small>Meta Content</small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.Content.meta_content",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Content','div'=>false));?>
								    </div>			
								</div>
								</div>
