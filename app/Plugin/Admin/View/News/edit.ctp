						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group">
								    ...
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.News.meta_title",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Title','div'=>false));?>
								    </div>
								    <label for="group_name" class="col-sm-2 control-label"><small>Meta Keyword</small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.News.meta_keyword",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Keyword','div'=>false));?>
								    </div>
								</div>
								 <div class="form-group">
								    <label for="group_name" class="col-sm-2 control-label"><small>Meta Content</small></label>
								    <div class="col-sm-4">
								       <?php echo $this->Form->input("$k.News.meta_content",array('label' => false,'class'=>'form-control','placeholder'=>'Meta Content','div'=>false));?>
								    </div>
								     <label for="group_name" class="col-sm-2 control-label">Status</label>
								    <div class="col-sm-4">
									<?php echo $this->Form->select("$k.News.status",array("Active"=>"Active","Suspend"=>"Suspend"),array('empty'=>null,'label' => false,'class'=>'form-control input-sm validate[required]','div'=>false));?>
								    </div>
								</div>
