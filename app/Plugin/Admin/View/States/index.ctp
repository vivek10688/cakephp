...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('States');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'States')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New State'),array('controller'=>'States','action'=>'add'),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Form->create(array('name'=>'deleteallfrm','action' => 'deleteall'));?>    
	...
	<div class="table-responsive">
		...
		<tr>
		    ...
		    <th><?php echo $this->Paginator->sort('name',__('State Name'), array('direction' => 'asc'));?></th>
		    <th><?php echo __('Action');?></th>
		</tr>
		<?php foreach ($State as $post):
		$id=$post['State']['id'];?>
		<tr>
		    <td><?php echo $this->Form->checkbox(false,array('value' => $post['State']['id'],'name'=>'data[State][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
