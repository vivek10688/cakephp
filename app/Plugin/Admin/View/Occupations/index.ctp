...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Occupations');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Occupations')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Occupation'),array('controller'=>'Occupations','action'=>'add'),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Form->create(array('name'=>'deleteallfrm','action' => 'deleteall'));?>    
	...
	<div class="table-responsive">
		...
		<?php foreach ($Occupation as $post):
		$id=$post['Occupation']['id'];?>
		<tr>
		    <td><?php echo $this->Form->checkbox(false,array('value' => $post['Occupation']['id'],'name'=>'data[Occupation][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
		    <td><?php echo $serialNo++; ?></td>
		    <td><?php echo h($post['Occupation']['name']); ?></td>
