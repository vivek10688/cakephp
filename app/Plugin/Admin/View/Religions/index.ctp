...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Religions');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Religions')); echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Religion'),array('controller'=>'Religions','action'=>'add'),array('escape'=>false,'escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Form->create(array('name'=>'deleteallfrm','action' => 'deleteall'));?>    
	...
	<div class="table-responsive">
		...
		<?php foreach ($Religion as $post):
		$id=$post['Religion']['id'];?>
		<tr>
		    <td><?php echo $this->Form->checkbox(false,array('value' => $post['Religion']['id'],'name'=>'data[Religion][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
