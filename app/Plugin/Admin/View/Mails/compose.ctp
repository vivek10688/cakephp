...
$memberUrl=$this->Html->url(array('controller'=>'Mails','action'=>'membersearch'));?>
...
<div class="panel">
		...
		<?php echo $this->Form->create('Mail', array( 'controller' => 'Mails','class'=>'form-horizontal'));?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <?php echo $this->Form->input('to_email',array('label' => false,'id'=>'memberId','class'=>'form-control','placeholder'=>__('Search Member User Name'),'div'=>false));?>
			</div>
                    </div>
		    <div class="form-group">
